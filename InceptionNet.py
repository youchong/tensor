...
def inception_v3_arg_scope(weight_decay=0.00004,stddev=0.1,batch_norm_var_collection='moving_vars'):
    batch_norm_params = {
        ...
        'variables_collections':{
            ...
            'movint_variance':[batch_norm_var_collection]
            }
        }
        ...
        with slim.arg_scope([slim.conv2d,slim.max_pool2d,slim.avg_pool2d],stride=1,padding='SAME'):
            with tf.variable_scope('Mixed_5b'):
                ...
                with tf.variable_scope('Branch_2'):
                    ...
                    branch_3 = slim.conv2d(branch_2,96,[3,3],scope='Conv2d_0c_3x3')
            ...
            with tf.variable_scope('Mixed_6b'):
                ...
                with tf.variable_scope('Branch_2'):
                    ...
                    branch_2 = slim.conv2d(branch_2,128,[7,1],scope='Conv2d_0b_1x7')
                    branch_2 = slim.conv2d(branch_2,128,[1,7],scope='Conv2d_0c_7x1')
            ...
            with tf.variable_scope('Mixed_6c'):
                ...
                with tf.variable_scope('Branch_2'):
                    ...
                    branch_2 = slim.conv2d(branch_2,160,[7,1],scope='Conv2d_0b_1x7')
                    branch_2 = slim.conv2d(branch_2,160,[1,7],scope='Conv2d_0c_7x1')
                    branch_2 = slim.conv2d(branch_2,160,[7,1],scope='Conv2d_0d_1x7')
                    branch_2 = slim.conv2d(branch_2,192,[1,7],scope='Conv2d_0e_7x1')
                with tf.variable_scope('Branch_3'):
                    branch_3 = slim.avg_pool2d(net,[3,3],scope='AvgPool_0a_3x3')
                    branch_3 = slim.conv2d(branch_3,192,[1,1],scope='Conv2d_0b_1x1')
            ...
            with tf.variable_scope('Mixed_6e'):
                ...
                with tf.variable_scope('Branch_2'):
                    ...
                    branch_2 = slim.conv2d(branch_2,192,[7,1],scope='Conv2d_0b_1x7')
                    branch_2 = slim.conv2d(branch_2,192,[1,7],scope='Conv2d_0c_7x1')
